...
[ -n "$1" ] && {
	case "$1" in
		...
		tftp)
			...
			stop_daemons; stop_web; stop_tr69; stop_wlan; stop_usb; stop_voip;
	...
	stop_daemons; stop_web; stop_tr69; stop_tftp; stop_wlan; stop_usb; stop_voip;
	stop_multicast; stop_qos; stop_dsl; stop_misc; stop_ppa; free_ramdisk;
	_dbg killall -9 stunnel
}
