...
//#define WAVE400_DEBUG_OWN_MISMATCH
//#define WAVE400_DEBUG_FIX_FULL_BUFF

/*SynopGMAC can support up to 32 phys*/

//#define WAVE400_INLINE inline
#define WAVE400_INLINE
//#define WAVE400_STATIC_INLINE static inline
#define WAVE400_STATIC_INLINE
...
#define TRANSMIT_DESC_SIZE  256//12//256	//Tx Descriptors needed in the Descriptor pool/queue
#define RECEIVE_DESC_SIZE   256//12//256	//Rx Descriptors needed in the Descriptor pool/queue
...
typedef struct synopGMACDeviceStruct      
{
  ...
  void *TxDescFree;               /* start address of TX descriptors ring or chain, this is product of kmalloc  */
  void *RxDescFree;               /* start address of RX descriptors ring or chain, this is product of kmalloc  */
...
enum MiiRegisters
{
  ...
  PHY_100BTX_CTRL_REG       = 0x001f,		/*100BASE-TX Control Register*/
};
...
{		                      /*	Description	               bits	       R/W	default value  */
	...
	Mii_Speed_Auto 		 = 0x1000,   /* Auto-negotiation             6:13         	RW                      */
	Mii_Reset_Neg 		 = 0x0200,   /* Reset Speed negotiation      6:13         	RW                      */
...
enum Mii_Phy100_Status
{
	Mii_phy100_status_speed_10h	 	= 0x0004,
	Mii_phy100_status_speed_100h  	= 0x0008,
	
	Mii_phy100_status_full_duplex	= 0x0010,
	Mii_phy100_status_half_duplex	= 0x0000,
};
...
{                                         /* Bit description                                Bits     R/W   Reset value */
  ...
  DmaAddrAlignedBeats     = 0x02000000,   /* (AAL) Address-Aligned Beats                      25      RW        0      */ 
  DmaBurstLengthx8        = 0x01000000,   /* When set mutiplies the PBL by 8                  24      RW        0      */ 
  DmaUseSeparatePBL       = 0x00800000,   /* Dma use separate burst length for Tx and Rx     23                 0x00   */
  DmaRxBurstLength32      = 0x00400000,   /* Dma Rx burst length = 32                        17:22              0x00   */
  DmaRxBurstLength16      = 0x00200000,   /* Dma Rx burst length = 16                        17:22              0x00   */
  DmaRxBurstLength8       = 0x00100000,   /* Dma Rx burst length = 8                         17:22              0x00   */
  DmaRxBurstLength4       = 0x00080000,   /* Dma Rx burst length = 4                         17:22              0x00   */
  DmaRxBurstLength2       = 0x00040000,   /* Dma Rx burst length = 2                         17:22              0x00   */
  DmaRxBurstLength1       = 0x00020000,   /* Dma Rx burst length = 1                         17:22              0x00   */
...
{ 
  ...
  DmaRxStoreAndForward    = 0x02000000,   /* (RSF)Store and forward                           25      RW        0       */

  DmaDisableRxFramesFlush = 0x01000000,   /* (DFF)Do not flush Rx frames if no descriptors available  RW        0       */

  DmaTxStoreAndForward    = 0x00200000,   /* (TSF)Transmit Store and forward                  21      RW        0       */
...
#define synopGMACDmaError_any	synopGMACDmaError| \
								synopGMACDmaRxAbnormal| \
								synopGMACDmaRxStopped| \
								synopGMACDmaTxAbnormal| \
								synopGMACDmaTxStopped
...
//   DmaBusModeInit         = DmaFixedBurstEnable |   DmaBurstLength8   | DmaDescriptorSkip4       | DmaResetOff,
   ...
   /* 1000 Mb/s mode */
   DmaControlInit1000     = DmaTxStoreAndForward,//       | DmaTxSecondFrame ,

   /* 100 Mb/s mode */
   DmaControlInit100      = DmaTxStoreAndForward,
   
   /* 10 Mb/s mode */
   DmaControlInit10       = DmaTxStoreAndForward,
...
/*
  DmaIntEnable            = DmaIntNormal | DmaIntBusError 
                          | DmaIntTxUnderflow | DmaIntRcvOverflow
                          | DmaIntRxCompleted | DmaIntTxCompleted,
*/
...
//WAVE400_INLINE bool synopGMAC_is_desc_owned_by_dma(DmaDesc *desc);
...
//WAVE400_INLINE bool synopGMAC_is_desc_empty(DmaDesc *desc);
...
//WAVE400_INLINE bool synopGMAC_is_last_rx_desc(synopGMACdevice * gmacdev,DmaDesc *desc);
//WAVE400_INLINE bool synopGMAC_is_last_tx_desc(synopGMACdevice * gmacdev,DmaDesc *desc);
...
//WAVE400_INLINE void synopGMAC_take_desc_ownership(DmaDesc * desc);
...
//WAVE400_INLINE void synopGMAC_tx_checksum_offload_ipv4hdr(synopGMACdevice *gmacdev, DmaDesc *desc);
//WAVE400_INLINE void synopGMAC_tx_checksum_offload_tcponly(synopGMACdevice *gmacdev, DmaDesc *desc);
void synopGMAC_tx_checksum_offload_tcp_pseudo(synopGMACdevice *gmacdev, DmaDesc *desc);
#ifdef WAVE400_DEBUG_OWN_MISMATCH
int    synopGMAC_print_tx_desc_debug( synopGMACdevice* gmacdev);
#endif
