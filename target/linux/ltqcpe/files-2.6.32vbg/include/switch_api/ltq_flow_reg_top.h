...
/* Bit: 'CLK_STOP_CAPABLE' */
/* Description: 'clk stop capable' */
#define VR9_ANEG_EEE_1_CLK_STOP_CAPABLE_OFFSET            0x01D
#define VR9_ANEG_EEE_1_CLK_STOP_CAPABLE_SHIFT             2
#define VR9_ANEG_EEE_1_CLK_STOP_CAPABLE_SIZE              2
/* Bit: 'EEE_CAPABLE' */
/* Description: 'EEE capable' */
#define VR9_ANEG_EEE_1_EEE_CAPABLE_OFFSET                 0x01D
#define VR9_ANEG_EEE_1_EEE_CAPABLE_SHIFT                  0
#define VR9_ANEG_EEE_1_EEE_CAPABLE_SIZE                   2
/* -------------------------------------------------------------------------- */
/* Register: 'EEE auto negotiationoverides' for PORT 2 */
/* Bit: 'CLK_STOP_CAPABLE' */
/* Description: 'clk stop capable' */
#define VR9_ANEG_EEE_2_CLK_STOP_CAPABLE_OFFSET            0x01E
#define VR9_ANEG_EEE_2_CLK_STOP_CAPABLE_SHIFT             2
#define VR9_ANEG_EEE_2_CLK_STOP_CAPABLE_SIZE              2
/* Bit: 'EEE_CAPABLE' */
/* Description: 'EEE capable' */
#define VR9_ANEG_EEE_2_EEE_CAPABLE_OFFSET                 0x01E
#define VR9_ANEG_EEE_2_EEE_CAPABLE_SHIFT                  0
#define VR9_ANEG_EEE_2_EEE_CAPABLE_SIZE                   2
/* -------------------------------------------------------------------------- */
/* Register: 'EEE auto negotiationoverides' for PORT 3 */
/* Bit: 'CLK_STOP_CAPABLE' */
/* Description: 'clk stop capable' */
#define VR9_ANEG_EEE_3_CLK_STOP_CAPABLE_OFFSET            0x01F
#define VR9_ANEG_EEE_3_CLK_STOP_CAPABLE_SHIFT             2
#define VR9_ANEG_EEE_3_CLK_STOP_CAPABLE_SIZE              2
/* Bit: 'EEE_CAPABLE' */
/* Description: 'EEE capable' */
#define VR9_ANEG_EEE_3_EEE_CAPABLE_OFFSET                 0x01F
#define VR9_ANEG_EEE_3_EEE_CAPABLE_SHIFT                  0
#define VR9_ANEG_EEE_3_EEE_CAPABLE_SIZE                   2
/* -------------------------------------------------------------------------- */
/* Register: 'EEE auto negotiationoverides' for PORT 4  */
/* Bit: 'CLK_STOP_CAPABLE' */
/* Description: 'clk stop capable' */
#define VR9_ANEG_EEE_4_CLK_STOP_CAPABLE_OFFSET            0x020
#define VR9_ANEG_EEE_4_CLK_STOP_CAPABLE_SHIFT             2
#define VR9_ANEG_EEE_4_CLK_STOP_CAPABLE_SIZE              2
/* Bit: 'EEE_CAPABLE' */
/* Description: 'EEE capable' */
#define VR9_ANEG_EEE_4_EEE_CAPABLE_OFFSET                 0x020
#define VR9_ANEG_EEE_4_EEE_CAPABLE_SHIFT                  0
#define VR9_ANEG_EEE_4_EEE_CAPABLE_SIZE                   2
/* -------------------------------------------------------------------------- */
/* Register: 'EEE auto negotiationoverides' for PORT 5 */
/* Bit: 'CLK_STOP_CAPABLE' */
/* Description: 'clk stop capable' */
#define VR9_ANEG_EEE_5_CLK_STOP_CAPABLE_OFFSET            0x021
#define VR9_ANEG_EEE_5_CLK_STOP_CAPABLE_SHIFT             2
#define VR9_ANEG_EEE_5_CLK_STOP_CAPABLE_SIZE              2
/* Bit: 'EEE_CAPABLE' */
/* Description: 'EEE capable' */
#define VR9_ANEG_EEE_5_EEE_CAPABLE_OFFSET                 0x021
#define VR9_ANEG_EEE_5_EEE_CAPABLE_SHIFT                  0
#define VR9_ANEG_EEE_5_EEE_CAPABLE_SIZE                   2
/* -------------------------------------------------------------------------- */
