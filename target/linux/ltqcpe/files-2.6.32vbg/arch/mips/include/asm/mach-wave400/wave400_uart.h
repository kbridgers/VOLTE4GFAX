...
#define PORT_WAVE400	82

struct uart_port;
extern void wave400_uart_tx_isr(struct uart_port *port);
extern void wave400_uart_rx_isr(struct uart_port *port);
...
#define BASE_BAUD (WAVE400_SYSTEM_CLK / UART_BAUD_RATIO_DIV)
#define WAVE400_UART_IRQ	1
//WAVE400_SERIAL_IRQ_OUT_INDEX
#define SERIAL_PORT_DFNS			\
	/* UART CLK   PORT IRQ     FLAGS        */			\
	{ 0, BASE_BAUD, UART_BASE, WAVE400_UART_IRQ, STD_COM_FLAGS },	/* ttyS0 */	
