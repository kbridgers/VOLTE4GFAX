...
#elif defined(CONFIG_MTD_IFX_NAND)
    {IFX_GPIO_MODULE_DECT, IFX_GPIO_PIN_ID(0, 10), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_OUT | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_CLEAR | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_SET | IFX_GPIO_IOCTL_PIN_CONFIG_OD_SET},
#else
...
/* sw reset
*/
    {IFX_GPIO_MODULE_SWRESET, IFX_GPIO_PIN_ID(3, 6), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_IN | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_CLEAR | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_CLEAR },
...
struct ifx_led_device g_board_led_hw_config[] = {
    {
        .name               = "wlan0:green:red:amber",
        .default_trigger    = NULL,
        .phys_id            = IFX_LED_DUAL_MAKE_PHYS_ID(50, 49),
        .value_on           = 1,
        .value_off          = 0,
        .flags              = IFX_LED_DEVICE_FLAG_PHYS_GPIO | IFX_LED_DEVICE_FLAG_DUAL_LED,
    },
    {
        .name               = "apmode:green",
        .default_trigger    = NULL,
