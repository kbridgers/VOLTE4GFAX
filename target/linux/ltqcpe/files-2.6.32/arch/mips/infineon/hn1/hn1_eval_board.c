...
struct ifx_gpio_ioctl_pin_config g_board_gpio_pin_map[] = {
  ...
  //{IFX_GPIO_MODULE_USIF_UART, IFX_GPIO_PIN_ID(1, 11), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_IN | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_SET | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_SET},
   ...
   // {IFX_GPIO_MODULE_USIF_SPI_SFLASH, IFX_GPIO_PIN_ID(0, 14), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_OUT | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_SET | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_SET | IFX_GPIO_IOCTL_PIN_CONFIG_OD_SET},
     ...
     */
    {IFX_GPIO_MODULE_PAGE, IFX_GPIO_PIN_ID(2, 3), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_IN |
    IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_SET | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_SET},
    /*
    ...
    /*
     *  I2C interface: GPIO(0,3)=I2C_SDA, GPIO(1,3)=I2C_SLC
     */
    {IFX_GPIO_MODULE_I2C, IFX_GPIO_PIN_ID(0, 3), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_OUT | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_SET | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_SET | IFX_GPIO_IOCTL_PIN_CONFIG_OD_CLEAR},
    {IFX_GPIO_MODULE_I2C, IFX_GPIO_PIN_ID(1, 3), IFX_GPIO_IOCTL_PIN_CONFIG_DIR_OUT | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL0_SET | IFX_GPIO_IOCTL_PIN_CONFIG_ALTSEL1_CLEAR | IFX_GPIO_IOCTL_PIN_CONFIG_OD_CLEAR},
...
struct ifx_ledc_config_param g_board_ledc_hw_config = {
    ...
    .data_mask              = (1 << 24) - 1,
    .data                   = (1 << 0) | (1 << 22),  // LED0,1 - 1 is turning off,  Warning LED turns on by default
//    .data                   = (1 << 0) | (1 << 14) | (1 << 22),  // LED0,1 - 1 is turning off, LED14 - Warning LED turns on by default
...
#if 0 /* Connected to GPHY */
    {
        .name               = "sout22_eth_speed",
        .default_trigger    = NULL,
        .phys_id            = 2,
        .value_on           = 1,
        .value_off          = 0,
