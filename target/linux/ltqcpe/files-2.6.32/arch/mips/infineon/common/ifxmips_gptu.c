...
static int ifx_gptu_ioctl(struct file *, unsigned int, unsigned long);
#else
 ...
 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,36)
static int ifx_gptu_ioctl(struct file *file, unsigned int cmd,
	unsigned long arg)
#else
