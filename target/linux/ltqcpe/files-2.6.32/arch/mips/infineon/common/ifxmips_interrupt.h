...
#elif defined(CONFIG_AR9) || defined(CONFIG_VR9) || defined(CONFIG_AR10) || defined(CONFIG_HN1)
#  define ICU_OFFSET_OF_IVEC    2
#else
#  error  ICU_OFFSET_OF_IVEC is not defined (no platform info).
#endif

#if defined(CONFIG_DANUBE) || defined(CONFIG_AR9) || defined(CONFIG_VR9) || defined(CONFIG_AR10) || defined(CONFIG_HN1)
#  define ICU_IM_NUM            5
