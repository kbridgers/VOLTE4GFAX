...
#define IFX_RCU_VER_MID                 1
#define IFX_RCU_VER_MINOR               1
...
static int ifx_rcu_ioctl(struct file *filp, unsigned int cmd, unsigned long arg);
#else
