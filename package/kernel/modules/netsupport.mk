...
define KernelPackage/ipsec
  ...
  DEPENDS:=@!LINUX_2_4 +kmod-crypto-core +kmod-crypto-des +kmod-crypto-hmac +kmod-crypto-md5 +kmod-crypto-sha1
  KCONFIG:= \
	CONFIG_NET_KEY \
	CONFIG_XFRM_USER \
	CONFIG_XFRM_IPCOMP
...
define KernelPackage/ip6-tunnel
  ...
  DEPENDS:= @!LINUX_2_4 +kmod-ipv6 +kmod-iptunnel6
