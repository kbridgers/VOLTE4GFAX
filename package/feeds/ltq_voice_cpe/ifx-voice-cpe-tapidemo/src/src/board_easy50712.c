...
/**
   \file board_easy50712.c
   \date 2006-10-01
   \brief Interface implementation for EASY50712 board.
...
/** Name of board */
#ifdef EASY50712_V3
static const char* BOARD_NAME_EASY50712 = "EASY50712_V3";
#else /* EASY50712_V3 */
static const char* BOARD_NAME_EASY50712 = "EASY50712";
#endif /* EASY50712_V3 */
...
/* ============================= */
IFX_return_t BOARD_Easy50712_PrepareBoard(BOARD_t* pBoard, IFX_char_t* pPath);
IFX_return_t BOARD_Easy50712_PrepareNames(BOARD_t* pBoard);
IFX_return_t BOARD_Easy50712_GetCapabilities(BOARD_t* pBoard,
                                             IFX_char_t* pPath);
IFX_return_t BOARD_Easy50712_CfgPCMInterface(BOARD_t* pBoard,
                                             IFX_boolean_t hMaster);
IFX_void_t BOARD_Easy50712_RemoveBoard(BOARD_t* pBoard);
IFX_return_t BOARD_Easy50712_Init(BOARD_t* pBoard, PROGRAM_ARG_t* pProgramArg);
...
IFX_return_t BOARD_Easy50712_PrepareBoard(BOARD_t* pBoard, IFX_char_t* pPath)
{
   ...
   if (BOARD_Easy50712_PrepareNames(pBoard) == IFX_ERROR)
      return IFX_ERROR;
   ...
   pBoard->fSingleFD = IFX_FALSE;

   /** RTP streaming mode */
   pBoard->fUseSockets = IFX_TRUE;
#endif

   if (IFX_ERROR == BOARD_Easy50712_GetCapabilities(pBoard, pPath))
   {
      return IFX_ERROR;
   }
...
IFX_return_t BOARD_Easy50712_Init(BOARD_t* pBoard, PROGRAM_ARG_t* pProgramArg)
{
   ...
   if (BOARD_Easy50712_PrepareBoard(pBoard, pProgramArg->sPathToDwnldFiles) == IFX_ERROR)
   {
       return IFX_ERROR;
   }
   ...
   if (BOARD_Easy50712_CfgPCMInterface(pBoard,
   ...
   if (!pProgramArg->oArgFlags.nNoDect)
   {
      ...
      {
         TD_TRACE(TAPIDEMO, DBG_LEVEL_HIGH, TD_DEV_NOT_SET,
...
IFX_return_t BOARD_Easy50712_Register(BOARD_t* pBoard)
{
   ...
   pBoard->pszBoardName = BOARD_NAME_EASY50712;
   pBoard->Init = BOARD_Easy50712_Init;
