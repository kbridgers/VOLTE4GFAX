...
# TODO: This can change very much per platform, so the whole function should be replaced 
# in future revisions by a hook that calls a function from mtlk_init_platform.sh
pbc_init () {
	PBC_NAME=$1
	PBC_TRIGGER=$2
