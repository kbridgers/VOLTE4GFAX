...
strip_section mtidl_item_0 'binary_type=mtlk_wssa_drv_peer_aggregation_t' > $target_path/mtdump.mtidlc_WLANFlowStatus
strip_section mtidl_item_1 'binary_type=mtlk_wssa_drv_wlan_stats_t' >> $target_path/mtdump.mtidlc_WLANFlowStatus
